...
extern int		random_depth;		// main.c
extern double	random_number;		// main.c
extern int		log2_boundary;		// main.c
...
void	qsort_swap3		(void *base, size_t nmemb, size_t size, int (*compare)(const void *, const void *));
void	qsort_tail		(void *base, size_t nmemb, size_t size, int (*compare)(const void *, const void *));
void	qsort_tail1		(void *base, size_t nmemb, size_t size, int (*compare)(const void *, const void *));
